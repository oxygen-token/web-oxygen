    ...
    return (
      <div className={cn("flex flex-col justify-between min-h-[80px]", className)}>
        ...
        <input
          ref={forwardedRef}
          className={cn(
            "!border px-4 !placeholder:text-gray-300 !placeholder:text-[10px] !text-white/90",
            "outline-2 focus-visible:outline-green focus-visible:!border focus-visible:!border-green-500/70",
            "transition-all duration-200 appearance-none",
            "bg-white/10 backdrop-blur-md border-white/15 hover:bg-white/15 focus:bg-white/15 shadow-inner",
            {
