  ...
  return (
    <div className="relative rounded-lg overflow-hidden h-16 sm:h-20">
      ...
      <div className="relative h-full flex items-center justify-between p-4">
        ...
        <div className="flex items-center space-x-4 bg-white bg-opacity-10 border border-white border-opacity-20 rounded-lg px-3 py-1.5 hover:bg-opacity-20 transition-all duration-200">
